...
def new_agenda_create(sender, instance, created, *args, **kwargs):
    if created:
        new_agenda = instance
        MondaySchedules.objects.create(agenda=new_agenda, start_time='07:00', end_time='17:00')
        TuesdaySchedules.objects.create(agenda=new_agenda, start_time='07:00', end_time='17:00')
        WednesdaySchedules.objects.create(agenda=new_agenda, start_time='07:00', end_time='17:00')
        ThursdaySchedules.objects.create(agenda=new_agenda, start_time='07:00', end_time='17:00')
        FridaySchedules.objects.create(agenda=new_agenda, start_time='07:00', end_time='17:00')
...
class MondaySchedules(models.Model):
    ...
    OPEN_TIME_CHOISES = [
        ('AM', (('00:00', '0:00'),('00:15', '0:15'),('00:30', '0:30'),('00:45', '0:45'),
                ('01:00', '1:00'),('01:15', '1:15'),('01:30', '1:30'),('01:45', '1:45'),
                ('02:00', '2:00'),('02:15', '2:15'),('02:30', '2:30'),('02:45', '2:45'),
                ('03:00', '3:00'),('03:15', '3:15'),('03:30', '3:30'),('03:45', '3:45'),
                ('04:00', '4:00'),('04:15', '4:15'),('04:30', '4:30'),('04:45', '4:45'),
                ('05:00', '5:00'),('05:15', '5:15'),('05:30', '5:30'),('05:45', '5:45'),
                ('06:00', '6:00'),('06:15', '6:15'),('06:30', '6:30'),('06:45', '6:45'),
                ('07:00', '7:00'),('07:15', '7:15'),('07:30', '7:30'),('07:45', '7:45'),
                ('08:00', '8:00'),('08:15', '8:15'),('08:30', '8:30'),('08:45', '8:45'),
                ('09:00', '9:00'),('09:15', '9:15'),('09:30', '9:30'),('09:45', '9:45'),
